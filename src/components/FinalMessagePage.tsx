  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          No color can ever match the brightness you bring into my life. 💖
           This Holi was special because I got to celebrate it with you. 
           Let’s keep adding more beautiful shades to our love story—one color,
           one smile, one moment at a time. ❤️🎨
        </motion.p>
        <motion.div
