  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      >
        <p>
          Hii Madam Jii, <br /><br />
          Happy Holi! Just like our love, may this festival be full of the brightest colors,
          laughter, and endless joy. This Holi was even more special because we got to share
          those little playful moments together. Let’s keep making every festival as beautiful as our bond! ❤️🎨
          And always remember, I just want you to keep smiling, just like you always do. 😊💖 
          I love you more than words can say, and I'll always be here for you, no matter what.
        </p>
      </div>
