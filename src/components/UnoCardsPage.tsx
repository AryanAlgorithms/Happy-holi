  ...
  const cards: UnoCardData[] = [
    {
      ...
      number: "1",
      photoUrl: Img1,
      caption: "Every moment with you is a beautiful memory in my heart",
      musicName: "Ajab Si",
      musicUrl: Music1,
    },
    {
      ...
      number: "2",
      photoUrl: Img2,
      caption: "In your arms, I found my safest place",
      musicName: "Bulleya",
      musicUrl: Music2,
    },
    {
      ...
      number: "3",
      photoUrl: Img3,
      caption: "You and me, a love story written in the stars",
      musicName: "Perfect",
      musicUrl: Music3,
    },
    {
      ...
      number: "4",
      photoUrl: Img4,
      caption: "you’ve filled my life with love and joy. Happy Holi, my love",
      musicName: "Rangrez",
      musicUrl: Music4,
    },
  ];
  ...
  return (
    ...
    >
      <h2 className="text-white text-3xl font-bold text-center mb-12 pt-10">
       Here are some of our best photos, our most beautiful moments together and the songs I dedicated to you... 
      </h2>
